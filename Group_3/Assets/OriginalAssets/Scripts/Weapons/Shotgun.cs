...
public class Shotgun : SemiAutoGun
{
    ...
    {
        // Play pull sound
        if (gunAudioSource != null && handlePullClip != null)
            gunAudioSource.PlayOneShot(handlePullClip);
        ...
        if (hasRoundChambered)
        {
            ...
            if (gunAudioSource != null && shellEjectClip != null)
                gunAudioSource.PlayOneShot(shellEjectClip);
    ...
    private void ChamberFromTube()
    {
        ...
        if (gunAudioSource != null && handleReleaseClip != null)
            gunAudioSource.PlayOneShot(handleReleaseClip);
    ...
    public override void InsertAmmo(int amount)
    {
        ...
        if (gunAudioSource != null && shellInsertClip != null)
            gunAudioSource.PlayOneShot(shellInsertClip);
